...
<x-page-title title="Dashboard" :breadcrumbs="['Admin', 'Dashboard']"/>
<div class="row">
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h2 class="mt-4 ff-secondary fw-semibold">
                            <span class="counter-value">2,450</span>
                        </h2>
    ...
    <div class="col-xxl-3 col-sm-6">
        <div class="card card-animate">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <p class="fw-medium text-muted mb-0">Revenue</p>
                        <h2 class="mt-4 ff-secondary fw-semibold">₹85,420</h2>
                        <p class="mb-0 text-muted">
                            <span class="badge bg-success-subtle text-success mb-0">
                                <i class="ri-arrow-up-line align-middle"></i>
                                8.2 %
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h2 class="mt-4 ff-secondary fw-semibold">320</h2>
                        <p class="mb-0 text-muted">
                            <span class="badge bg-warning-subtle text-warning mb-0">
                               <i class="ri-arrow-up-line align-middle"></i>3.1 %
            ...
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div>
                        ...
                        <small class="text-muted">450 Orders</small>
                    </div>
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div>
                        <h6 class="mb-1">Fashion</h6>
                        <small class="text-muted">320 Orders</small>
                    </div>
