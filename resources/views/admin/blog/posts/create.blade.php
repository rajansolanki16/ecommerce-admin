<x-admin.header :title="'Create Blog Post'" />

<x-page-title title="Create Post" :breadcrumbs="['Blog', 'Posts', 'Create']" />
                ...
                <form action="{{ route('blog.posts.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" name="published_at" id="published_at" value="{{ old('published_at') }}" class="form-control @error('published_at') is-invalid @enderror">
