                        ...
                        <div class="d-flex flex-wrap align-items-center gap-2">
                            ...
                            <div class="dropdown card-header-dropdown sortble-dropdown flex-shrink-0">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <button class="dropdown-item sort" data-sort="user_name">Name</button>
                                    <button class="dropdown-item sort" data-sort="email">Email</button>
                                    <button class="dropdown-item sort" data-sort="role">Role</button>
                                    <button class="dropdown-item sort" data-sort="created">Created Date</button>
                                </div>
                            </div>
                    ...
                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                        ...
                        <thead class="text-muted table-light">
                            <tr>
                                ...
                                <th class="sort cursor-pointer" data-sort="user_name">User</th>
                                ...
                                <th class="sort cursor-pointer" data-sort="created">Created Date</th>
                                <th> Action</th>
                            </tr>
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="text-center py-4">
                                            ...
                                            <p class="text-muted mb-0"> No users available right now.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
